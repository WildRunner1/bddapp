        ...
        <div>
          ...
          <article>
            ...
            <div className='articleBody'>
              <div className="techStackList"><img alt="*" src="icons/electron-icon.svg" width="50px"/><label className="labelTech"><h4>Electron.js</h4></label><br></br></div>
              ...
              <div className="techStackList"><img alt="*" src="icons/react-js-icon.svg" width="50px"/><label className="labelTech"><h4>React JS</h4></label><br></br></div>
